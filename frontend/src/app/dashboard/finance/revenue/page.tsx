    ...
    <div className="space-y-6">
      ...
      {loading && !overview ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <button
            type="button"
            onClick={() => router.push('/dashboard/finance/revenue/rooms')}
          ...
          <button
            type="button"
            onClick={() => router.push('/dashboard/finance/revenue/bar')}
            className="bg-white border rounded-lg p-4 text-left hover:border-teal-500 hover:shadow-sm transition"
          >
          ...
          <button
            type="button"
            onClick={() => router.push('/dashboard/finance/revenue/restaurant')}
            className="bg-white border rounded-lg p-4 text-left hover:border-teal-500 hover:shadow-sm transition"
          >
          ...
          <button
            type="button"
            onClick={() => router.push('/dashboard/finance/revenue/other')}
            className="bg-white border rounded-lg p-4 text-left hover:border-teal-500 hover:shadow-sm transition"
          >
